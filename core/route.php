...
class route {
    ...
    private static function matchdroute($method, $uri) {
        ...
        // ill make these switch cases STFU
        ...
        if (!in_array($uri, self::$routes)) {
            ...
            if(is_callable(self::$r403)) {
                return call_user_func_array(self::$r403, []);
            } else {
                return 404;
            }
        }
        if (!in_array($uri, self::$routes)) {
            ...
            if(is_callable(self::$r400)) {
                return call_user_func_array(self::$r400, []);
            } else {
                return 404;
            }
        }
